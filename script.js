...
if (submitDailyLogBtn) {
  submitDailyLogBtn.addEventListener("click", () => {
    ...
    modalContent.innerHTML = `
      ...
      <input type="number" id="logHours">

      <label>Tasks Completed</label>
      <input type="number" id="logTasks">

      <label>Plan Adherence (0-10)</label>
      <input type="number" id="logAdherence">

      <label>Self Rating (0-10)</label>
      <input type="number" id="logRating">
    ...
    document.getElementById("saveLogBtn").onclick = () => {
      ...
      const tasks = Number(document.getElementById("logTasks").value);
